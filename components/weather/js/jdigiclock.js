...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            regional['fr'] = {
                monthNames: ['Jan', 'Fev', 'Mar', 'Avr', 'Mai', 'Jui', 'Jui', 'Aou', 'Sept', 'Oct', 'Nov', 'Dec'],
            ...
            return this.each(function() {
                ...
                html    += '<p id="left_arrow"><img src="'+path+'components/weather/images/icon_left.png" /></p>';
                html    += '<p id="right_arrow"><img src="'+path+'components/weather/images/icon_right.png" /></p>';
    ...
    $.fn.displayClock = function(el) {
        $.fn.getTimeWeather(el);
        setTimeout(function() {$.fn.displayClock(el)}, $.fn.delayWeather());
    }
    ...
    $.fn.delayWeather = function() {
        var now = new Date();
        var delayWeather = (60 - now.getSeconds()) * 1000;
        
        return delayWeather;
    }

    $.fn.getTimeWeather = function(el) {
        var now = new Date();
        var old = new Date();
    ...
    $.fn.getWeather = function(el) {
        ...
        $.getJSON('components/weather/proxy/' + proxy + '?location=' + el.weatherLocationCode + '&metric=' + el.weatherMetric, function(data) {
...
$(document).ready(function() {
    $('#digiclock').jdigiclock({
        weatherLocationCode: 'ASI|AM|AM011|YEREVAN',
        clockImagesPath: path + 'components/weather/images/clock/',
        weatherImagesPath: path + 'components/weather/images/weather/',
        lang: 'fr'
    });
});