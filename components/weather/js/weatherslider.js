...
jQuery(document).ready(function(){
    ...
    jQuery("#weatherslider").weatherSlider({
        responsive        : true,
        imgPath           : path + 'components/weather/images/weatherslider/',
        WWOAPIKey         : 'hqcuextc5s4bkf6h5qzh2dya',
        measurement       : 'metric',
        timeFormat        : 24,
        daytime           : [7,19],
        windyWeather      : 18,
        ...
        windDirection	  : 'auto',
        SSL               : true,
        locations         : ['Erevan', 'Sevan', 'Tsakhkadzor', 'Tatev', 'Gyumri'],
        language          : {
		...
		get					: 'Météo de',
		not					: 'Lieu non trouvé',
		una					: 'Ne peut pas determiner votre position actuelle.',
		search                                  : 'Nouvelle position ...',
		...
		'113':'Ensoleillé, Clair',
                ...
                '122':'Couvert',
                '143':'Brouillard',
                '176':'Averses à proximité' ,
                '179':'Averses de neige à proximité',
                '182':'Averses de neige fondue à proximité',
                '185':'Légère bruine verglaçante à proximité',
                '200':'Épidémies de Pluie à proximité',
                '227':'La poudrerie',
                '230':'Blizzard',
                '248':'Brouillard' ,
                ...
                '284':'Bruine verglaçante lourde',
                '293':'Pluie Averses',
                '296':'Averses',
                '299':'Pluie modérée',
                '302':'Pluie',
                '305':'De fortes pluies occasionnelles',
                '308':'Fortes pluies',
                '311':'Faible pluie verglaçante',
                '314':'Modérée / Forte pluie verglaçante',
                '317':'Grésil léger',
                '320':'Grésil modérée ou lourde',
                '323':'Averses de neige légère',
                '326':'Neige Lumière',
                '329':'Averses de neige modérée',
                '332':'Neige modérée',
                '335':'Averses de neige lourde',
                '338':'Neige lourde',
                '350':'Grésil',
                '353':'Ensoleillé',
                '356':'Légère pluie',
                '359':'Des pluies torrentielles douche',
                '362':'Averses de neige éparses',
                '365':'Averses de grésil modérés ou lourds',
                '368':'Averses de neige légère',
                '371':'Averses de neige modérées ou fortes',
                '374':'De légères averses de granules de glace',
                '377':'Averses modérées ou fortes de granules de glace',
                '386':'Pluie et Averses, Orageux',
                '389':'Pluie modérée ou forte, Orageux',
                '392':'Neige légère Ciel, Orageux',
                '395':'Neige modérée ou forte, Orageux'
